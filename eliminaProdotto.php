    ...
    <div class="container">
                    ...
                    <div class="row tm-header-inner">
                        <div class="col-md-6 col-12">
                            ...
                            <div class="tm-site-text-box">
                                ...
                                <h6 class="tm-site-description">sto facendo qusto sito web </h6>
                            </div>
                        </div>
        ...
        <main>
            <header class="row tm-welcome-section">
                ...
                <p class="col-12 text-center">quale prodotto vuole eliminare? </p>
            </header>


            
        <form class="form-style-9" action="risultato_elimina_prodotto.php" method="GET" >
        <ul>
        <li>


        </select>
        <p>scegliere un prodotto </p>
        <select name="nome_prodotto" >

        <?php 
            $connection = mysqli_connect("remotemysql.com","JQGxKmZtbe","5g0uKMH8Kw","JQGxKmZtbe");
            $query = "SELECT prodotti.nome_p FROM prodotti";
            ...
            if(mysqli_num_rows($result) != 0){
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<option value = '$row[0]' class='field-style field-split align-left'>$row[0]</option>";
                   
                 }

            }else{
                        echo "inserire prima un prodotto nel database.";
             }
