    ...
    <div class="container">
        ...
        <main>
            <header class="row tm-welcome-section">
                <h2 class="col-12 text-center tm-section-title">elimina elementi</h2>
                <p class="col-12 text-center">quale categoria vuole eliminare? </p>
            </header>


            
        <form class="form-style-9" action="risultato_elimina_categoria.php" method="GET" >
        <ul>
        <li>
        ...
        <?php 
            //$connection = mysqli_connect("localhost","root","","mercato",3325);
            ...
            if(mysqli_num_rows($result) != 0){
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<option value = '$row[0]'>$row[0]</option>";
                        ...
                        echo "inserire prima un categoria nel database.";
             }
        ...
        <li>
        <input type="submit" value="elimina categoria" />
        </li>
        </ul>
