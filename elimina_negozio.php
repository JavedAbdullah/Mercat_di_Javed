...
<body>
    ...
    <div class="container">
        ...
        <main>
            <header class="row tm-welcome-section">
                ...
                <p class="col-12 text-center">quale negozio vuole eliminare? </p>
            </header>


            
        <form class="form-style-9" action="risultato_elimina_negozio.php" method="GET" >
        <ul>
        <li>
    ...
    \
            ...
            if(mysqli_num_rows($result) != 0){
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<option value = '$row[0]'>$row[0]</option>";
                        ...
                        echo "inserire prima un negozio nel database.";
             }
        ...
        <li>
        <input type="submit" value="elimina negozio" />
        </li>
        </ul>
