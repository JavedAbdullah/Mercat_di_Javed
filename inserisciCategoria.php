    ...
    <div class="container">
                    ...
                    <div class="row tm-header-inner">
                        <div class="col-md-6 col-12">
                            ...
                            <div class="tm-site-text-box">
                                ...
                                <h6 class="tm-site-description">sto facendo questo sito web</h6>
                            </div>
                        </div>
        ...
        <main>
            <header class="row tm-welcome-section">
                ...
                <p class="col-12 text-center">inserire una categoria </p>
            </header>


            
        <form class="form-style-9" action="risultato_categoria.php" method="GET" >
        <ul>
        <li>
            <input type="text" name="id_c" class="field-style field-split align-left" placeholder="id della categoria" />
            <input type="text" name="nome_c" class="field-style field-split align-right" placeholder="nome della categoria" />

        </li>
        <li>
        <input type="submit" value="inserisci categoria" />
        </li>
        </ul>
        </form>
