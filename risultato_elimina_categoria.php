...
<body>
    ...
    <div class="container">
        ...
        <main>
            ...
            $query = "DELETE FROM `categorie` WHERE categorie.nome_c = '$nome_categoria'";
            $result = mysqli_query($connection,$query);

           echo " <h2 class='col-12 text-center tm-section-title'>eliminaxione della categoria '$nome_categoria' avvenuta con successo</h2>";
