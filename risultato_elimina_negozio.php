    ...
    <div class="container">
                    ...
                    <div class="row tm-header-inner">
                        <div class="col-md-6 col-12">
                            ...
                            <div class="tm-site-text-box">
                                ...
                                <h6 class="tm-site-description">ciao sto facendo qeusto sito web</h6>
                            </div>
                        </div>
        ...
        <main>
            <header class="row tm-welcome-section">
                <h2 class="col-12 text-center tm-section-title">eliminato</h2>
              
            </header>

       
            <?php
              $nome_negozi = $_GET["nome_negozio"];
              $connection = mysqli_connect("remotemysql.com","JQGxKmZtbe","5g0uKMH8Kw","JQGxKmZtbe");
              $query = "DELETE FROM `negozi` WHERE negozi.nome_n = '$nome_negozi'";
              $result = mysqli_query($connection,$query);
             echo" <h2 class='col-12 text-center tm-section-title'>il negozio '$nome_negozi' eliminato con successo </h2>";
